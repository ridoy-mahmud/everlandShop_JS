...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    <img class="product-image" src=${image}></img>
      ...
      <h6 class="text-center px-3 mt-3 title-text">${product.title}</h6>
      ...
      <p>(<span class="count-color fw-normal">${product.rating.count}</span> Reviews)</p> 
      <div class="button-custom">
      <button onclick="addToCart(${product.id},${product.price})" id="addToCart-btn" class="buy-now btn btn-dark btn-block btn-style">Add to cart</button>
      <button id="details-btn" class="btn btn-success btn-block btn-style">Details</button>
      </div>
      </div>
      `;
